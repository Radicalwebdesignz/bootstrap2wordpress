...
if ( ! function_exists( 'bootstrap2wordpress_setup' ) ) :
	...
	function bootstrap2wordpress_setup() {
		...
		register_nav_menus( array(
			...
			'footer_menu' => esc_html__( 'Footer Menu', 'bootstrap2wordpress' )
		) );
...
function bootstrap2wordpress_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Another Sidebar', 'bootstrap2wordpress' ),
        'id'            => 'sidebar-2',
        'description'   => esc_html__( 'Add Another widgets here.', 'bootstrap2wordpress' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
